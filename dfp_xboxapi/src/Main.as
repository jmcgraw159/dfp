package
{
	...
	{	
		...
		private function setupCopyright():void
		{
			...
			var mItemTwo:ContextMenuItem = new ContextMenuItem("API Provided By Xbox API", true);
			mItemTwo.addEventListener(ContextMenuEvent.MENU_ITEM_SELECT, apiClick);
		...
		private function apiClick(event:ContextMenuEvent):void
		{
			var urlRequest:URLRequest = new URLRequest("http://xboxapi.com");
